...
INSERT INTO `category` VALUES (1,'Series Americanas'),(2,'Anime'),(3,'Películas'),(4,'Comics'),(5,'Cosplay'),(6,'Porcelana Fría'),(7,'Dije'),(8,'Ciencia Ficción'),(9,'Bijou'),(10,'Pelucas'),(11,'Harry Potter');
...
INSERT INTO `client_purchase` VALUES (18,1),(15,2),(14,3),(16,5),(9,6);
...
INSERT INTO `material` VALUES (1,10,'Dije Rel. de la Muerte Grande'),(2,10,'Dije Sailor Moon'),(3,20,'Argollas Plateadas Chiquitas'),(4,50,'Horas de Trabajo'),(5,180,'Peluca Toyokalon'),(6,150,'Peluca Kanekalon'),(7,10,'Dije Harry Potter');
...
INSERT INTO `material_category` VALUES (2,2),(1,3),(6,5),(1,7),(2,7),(7,7),(1,9),(2,9),(3,9),(7,9),(5,10),(6,10),(7,11);
...
INSERT INTO `materialquantity` VALUES (1,1,2,1),(2,0.25,4,1),(3,1,1,2),(4,0.25,4,2),(5,1,5,3),(6,1,4,4),(7,1,1,5),(8,1,4,5),(9,1,1,6),(10,1,4,6),(11,1,1,7),(12,1,4,7),(13,1,1,8),(14,1,4,8),(15,2,1,9),(16,1,4,9),(17,1,1,10),(18,1,4,10),(19,1,7,11),(20,1,4,11);
...
INSERT INTO `materialstock` VALUES (1,0,'Unidades',1),(2,20,'Unidades',2),(3,2,'Bolsitas',3),(4,72,'Unidades',4),(5,15,'Unidades',5),(6,10,'Unidades',6),(7,0,'Unidades',7);
...
INSERT INTO `product` VALUES (1,'Choker Sailor Moon',100),(2,'Choker Rel de la Muerte',60),(3,'Peluca Toyokalon',350),(4,'Corte Simple',150),(5,'Pulsera Rel. de la Muerte',60),(6,'Collar Rel. de la Muerte',50),(7,'Llavero Rel de la Muerte',40),(8,'Hebilla Rel de la muerte',40),(9,'Prendedor Rel de la Muerte',30),(10,'Anillo Rel de la Muerte',30),(11,'Collar Harry Potter',50);
...
INSERT INTO `product_category` VALUES (1,2),(2,3),(5,3),(6,3),(7,3),(8,3),(9,3),(10,3),(11,3),(3,5),(4,5),(1,7),(2,7),(6,7),(7,7),(8,7),(9,7),(10,7),(11,7),(1,9),(2,9),(5,9),(6,9),(8,9),(3,10),(4,10),(11,11);
...
INSERT INTO `product_material` VALUES (2,1),(5,1),(6,1),(7,1),(8,1),(9,1),(10,1),(1,2),(1,4),(2,4),(4,4),(5,4),(6,4),(7,4),(8,4),(9,4),(10,4),(11,4),(3,5),(11,7);
...
INSERT INTO `productstock` VALUES (1,0,'Unidades',1),(2,8,'Unidades',2),(3,12,'Unidades',3),(4,19,'Unidades',4),(5,14,'Unidades',5),(6,2,'Unidades',6),(7,1,'Unidades',7),(8,1,'Unidades',8),(9,2,'Unidades',9),(10,5,'Unidades',10),(11,0,'Unidades',11);
...
INSERT INTO `purchase` VALUES (1,0,'2017-09-29'),(2,1,'2017-09-29'),(3,1,'2017-09-29'),(4,0,'2017-09-27'),(5,0,'2017-09-25'),(6,0,'2017-10-02');
...
INSERT INTO `purchase_purchasedetail` VALUES (1,1),(2,2),(2,3),(3,4),(4,5),(4,6),(4,7),(5,8),(5,9),(6,10);
...
INSERT INTO `purchasedetail` VALUES (1,1,100,1),(2,2,150,4),(3,2,350,3),(4,1,40,7),(5,1,100,1),(6,1,60,5),(7,1,350,3),(8,1,150,4),(9,2,350,3),(10,10,50,11);
...
INSERT INTO `supplier` VALUES (1,'Paula Bonetti',3),(2,'Chinos Genial',5);
...
INSERT INTO `supplier_category` VALUES (2,9),(1,10),(2,10);
...
-- Dump completed on 2017-10-09 21:10:58
